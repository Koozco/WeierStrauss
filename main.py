...
def parse():
    ...
    parser.add_argument("-a", default=2, help="The 'a' param of Weierstrass function. Default set to 2.")
    parser.add_argument("-b", default=2, help="The 'b' param of Weierstrass function. Default set to 2.")
    parser.add_argument("-p", "--plot", default=True, help="Draw plot of generated function. Default set to true")
    parser.add_argument("-c", default=16, help="Count of sounds in one riff. Default set to 16.")
    parser.add_argument("--octaves", default=3, help="Number of octaves. Default set to 3.", choices=[1, 3, 5])
    ...
    parser.add_argument("-r", "--riffs", help="Number of riffs in file", default=8)
    parser.add_argument("-i", "--iterations", help="Number of mutation iterations", default=2)
